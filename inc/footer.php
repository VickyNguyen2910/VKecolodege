...
<div class="container-fluid bg-white mt-5 bg-grey-dark">
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="index.php" class="d-inline-block mb-2 text-decoration-none">Trang Chủ</a> <br>
      <a href="rooms.php" class="d-inline-block mb-2 text-decoration-none">Phòng</a> <br>
      <a href="facilities.php" class="d-inline-block mb-2 text-decoration-none">Tiện Nghi</a> <br>
      <a href="contact.php" class="d-inline-block mb-2 text-decoration-none">Liên Hệ</a> <br>
      <a href="about.php" class="d-inline-block mb-2 text-decoration-none">Giới Thiệu</a>
    </div>
    <div class="col-lg-4 p-4">
        ...
        <a href="<?php echo $contact_r['insta'] ?>" class="d-inline-block text-decoration-none">
...
<h6 class="text-center bg-grey text-dark p-3 m-0">©	2024 Nguyen Kim Ha</h6>

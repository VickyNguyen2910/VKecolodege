...
<body class="bg-lgrey">
  ...
  <?php
  // Checking if the user is logged in and room ID is valid
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 my-5 mb-4 px-4 page-title">
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body">
            <form action="pay_now.php" method="POST" id="booking_form" onsubmit="return confirm('Do you want to submit the form?');">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <button id="book-now" type="submit" name="pay_now" class="btn w-100 text-white custom-bg shadow-none mb-1" disabled>Đặt Ngay</button>
                </div>
              </div>
            </form>
          </div>

<?php 
  ...
  define('SITE_URL','http://localhost:8888/vkhotel/');
  define('ABOUT_IMG_PATH',SITE_URL.'images/about/');
  define('CAROUSEL_IMG_PATH',SITE_URL.'images/carousel/');
  define('CAROUSEL_VIDEO_PATH',SITE_URL.'images/carousel/');
  ...
  define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/vkhotel/images/');
